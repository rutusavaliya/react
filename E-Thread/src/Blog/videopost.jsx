...
function Videopost() {
  return (
    <>
      ...
      <div className="video-section mt-10  -z-10 w-[1000px] mx-auto h-auto  ">
        <div className="image-section relative mb-10 after:absolute after:content-[''] after:w-[100%] after:h-[100%] after:bg-black after:top-0 after:left-0 after:right-0 after:bottom-0 after:rounded-md after:opacity-[0.2] after:z-10 " >
          <img src={Video1} className="rounded-md" alt="" />
              ...
              <div>
                <div className='flex mt-4'>
                  ...
                  <div className='pl-2'>
                    ...
                    <p className='text-[13px] text-[#777777] mt-3'>Duis hendrerit velit scelerisque felis tempus, id porta libero venenatis. Nulla facilisi.<br /> Phasellus viverra magna commodo dui lacinia tempus. Donec malesuada nunc non dui<br /> posuere, fringilla vestibulum urna mollis. Integer condimentum ac sapien quis maximus.</p>
                  </div>
                </div>
                ...
                <div className='flex mt-4 ml-10'>
                  ...
                  <div className='pl-2'>
                    ...
                    <p className='text-[14px] text-[#777777] mt-3'>Pellentesque habitant morbi tristique senectus et netus et malesuada fames <br/> ac turpis egestas. Suspendisse lobortis cursus lacinia. Vestibulum vitae leo id<br/> diam pellentesque ornare.</p>
                  </div>
                </div>
