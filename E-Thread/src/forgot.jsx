                    ...
                    <div className=" mt-14 ml-60 overflow-y-auto ">
                        <div className="flex flex-col justify-center">
                            ...
                            <form action="" className="">
                                <figcaption className="text-gray-500 pt-4 text-xs">Enter the email address you used you joined and we'll<br></br>send you instructions to reset your Password </figcaption>
